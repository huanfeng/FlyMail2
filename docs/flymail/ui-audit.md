...
**7. 长操作没有进度表达** — ✅ 已于第五轮处理，见第五节。
（实现时发现它不只是「缺进度」，那段代码本来就是坏的。）

**8. 侧栏与草稿列表仍无 error 态** — ✅ 已于第二轮处理，见第二节。

**9. 设置页 8 处 window.confirm 仍在** — ✅ 已于第五轮处理，见第五节。
...
**13. 撰写器校验错误显示在会滚走的位置** — ✅ 已于第五轮处理，见第五节。
