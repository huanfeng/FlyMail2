...
// DetermineFolderTypeByFlags determines folder type by IMAP flags
func DetermineFolderTypeByFlags(name, rawName string, flags []string) FolderType {
	...
	return DetermineFolderTypeAdvanced(name, rawName)
}
